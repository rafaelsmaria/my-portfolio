...
export default function SinglePost() {
    ...
    return (
        <main className='bg-gray-200 min-h-screenp-12' >
            <article className='container mx-auto bg-white rounded-lg' > 
                <header className='relative' >
                    <div className='absolute h-full w-full flex items-center justify-vcenter p-8' >
                        <div className='bg-white bg-opacity-75 rounded p-12' >
                            <h1 className='cursive text-3xl lg:text-6xl mb-4' >
                                {singlePost.title}
                            </h1>
                            <div className='flex justidy-center text-gray-800' >
