	...
	return (
		<main className='bg-white min-h-screen p-12' >
			<section className='container mx-auto' >
				<h1 className='text-5xl flex justify-center cursive pb-10' >Welcome to my adventures!</h1>
				{/* <h1 className='text-5xl flex justify-center cursive' >Blog Posts Page</h1> */}
				{/* <h2 className='text-lg text-gray-600 flex justify-center mb-12' >Welcome to my adventures!</h2> */}
